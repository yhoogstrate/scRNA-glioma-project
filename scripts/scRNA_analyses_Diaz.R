...
levels(object_1$seurat_clusters) <- gsub("^(1)$",paste0("\\1. OD"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(6|2|0|5)$",paste0("\\1. TAM?"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(7|3|4)$",paste0("\\1. T (?)"),levels(object_1$seurat_clusters))
...
# FeaturePlot(object = object_1, features = "CD74")
...
levels(object_1$seurat_clusters) <- gsub("^(5)$",paste0("\\1. OD"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(2)$",paste0("\\1. TAM ? CD74?"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(0|1|3|4|6)$",paste0("\\1. T"),levels(object_1$seurat_clusters))
...
tmp.1 <- FindMarkers(object_1, ident.1 = 2)
View(tmp.1)
...
FeaturePlot(object = object_1, features = "SOX2") # Tumor/AC
FeaturePlot(object = object_1, features = "SOX4") # Tumor/AC
...
ggplot(object_1@meta.data, aes(y=`nCount_RNA`, x=orig.ident)) +
  geom_jitter(cex=0.01)  +
  geom_hline(yintercept = 500,col="red") +
  geom_hline(yintercept = 7500,col="red") # + scale_y_log10()
...
levels(object_1$seurat_clusters) <- gsub("^(7)$",paste0("\\1. OD"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(8|9)$",paste0("\\1. TAM"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(0|1|2|3|4|5)$",paste0("\\1. T"),levels(object_1$seurat_clusters))
levels(object_1$seurat_clusters) <- gsub("^(6)$",paste0("\\1. T (double)"),levels(object_1$seurat_clusters))
...
object_1$seurat_clusters <- factor(object_1$seurat_clusters, levels=c(
  "0. T", "1. T", "2. T", "3. T", "4. T", "5. T", "6. T (double)",
  "8. TAM", "9. TAM",
  "7. OD"
))
...
tmp.6 <- FindMarkers(object_1, ident.1 = 6) # MALAT1 etc., cluster of double Tumor cells?
View(tmp.6)


tmp.7 <- FindMarkers(object_1, ident.1 = 7) # NEAT1
View(tmp.7)
FeaturePlot(object_1, features="NEAT1")
FeaturePlot(object_1, features="GSN")
FeaturePlot(object_1, features="SEPP1")
FeaturePlot(object_1, features="TUBB4A")
FeaturePlot(object_1, features="SEPT4") # OD


tmp.8 <- FindMarkers(object_1, ident.1 = 8) # CD74, HLA.., TAM?
head(tmp.8,n=15)
...
tmp.8.9 <- FindMarkers(object_1, ident.1 = 8, ident.2 = 9)
head(tmp.8.9,n=15)
